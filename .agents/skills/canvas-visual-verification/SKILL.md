...
6. Poll `http://127.0.0.1:5173` with mise-managed Node until it returns a successful response.
7. Open the URL with Playwright MCP and wait for loading to finish.
